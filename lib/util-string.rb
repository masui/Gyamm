...
if defined?($test) && $test
  class TestString < Test::Unit::TestCase
    ...
    def test_escape
      ...
      assert_equal("ABC%E3%81%82%E3%81%84%E3%81%86+%2B%23", "ABCあいう +#".escape)

      # test_unescape
      assert_equal('A', '%41'.unescape)
      assert_equal(' ', "+".unescape)
      assert_equal("!", '%21'.unescape)
      assert_equal("ABCあいう +#", "ABC%E3%81%82%E3%81%84%E3%81%86+%2B%23".unescape)
